# ランニング例 検証レポート (最終版 / 再検証: 2026-07-18, seed=42)
...
- 復元抽出によるリサンプリング: 1000 回, 標本サイズ 20
- 経験分布の平均: 2,093,859
- 標本平均の平均: 2,084,531
- 標本平均の標準偏差 (実測): 536,590.0
...
| おすすめ表示回数 vs 視聴回数 | +0.803 | 中〜強 (0.65〜0.85) | OK |
| 平均評価 vs 視聴回数 | +0.206 | 弱 (0.1〜0.3) | OK |
| 評価件数 vs 視聴回数 | +0.706 | 中〜強 (0.6〜0.8) | OK |
| 上映時間 vs 視聴回数 | +0.022 | ほぼ無相関 | OK |

注: おすすめ表示回数の設計目安は, 実データ確定値 r=0.8033 に合わせて 0.65〜0.85 へ調整した.
...
![単回帰散布図](figs/ch09_regression.png)
